import type { ServiceRoute, ServiceName } from '../types/api';
 ...
 */
export const getServiceByName = (serviceName: ServiceName): ServiceRoute | undefined => {
 ...
 */
export const getServiceByPrefix = (prefix: string): ServiceRoute | undefined => {
